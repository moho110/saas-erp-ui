    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['basic:account:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <el-form-item label="期初金额" prop="initialAmount">
          <el-input v-model="form.initialAmount" placeholder="请输入期初金额" />
        </el-form-item>
        <el-form-item label="当前余额" prop="currentAmount">
          <el-input v-model="form.currentAmount" placeholder="请输入当前余额" />
        </el-form-item>
        ...
        <el-form-item label="删除标记" prop="deleteFlag">
          <el-radio v-model="form.deleteFlag" label="1">删除</el-radio>
          <el-radio v-model="form.deleteFlag" label="0">保留</el-radio>
        </el-form-item>
      </el-form>
...
<script>
import { listAccount, getAccount, delAccount, addAccount, updateAccount } from "@/api/erp/account";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/account/export', {
        ...this.queryParams
