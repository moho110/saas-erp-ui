<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="msgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态，1未读 2已读" align="center" prop="status" />
...
<script>
import { listMsg, getMsg, delMsg, addMsg, updateMsg } from "@/api/erp/msg";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/msg/export', {
        ...this.queryParams
