    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['xsystem:role:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['xsystem:role:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listRole, getRole, delRole, addRole, updateRole } from "@/api/erp/role";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('xsystem/role/export', {
        ...this.queryParams
