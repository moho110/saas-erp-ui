  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="上级编号" prop="parentNumber">
        <el-input
          v-model="queryParams.parentNumber"
          placeholder="请输入上级编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="收缩" prop="state">
        <el-input
      ...
      <el-form-item label="功能按钮" prop="pushBtn">
        <el-input
          v-model="queryParams.pushBtn"
          placeholder="请输入功能按钮"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['xsystem:function:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['xsystem:function:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['xsystem:function:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['xsystem:function:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="上级编号" prop="parentNumber">
          <el-input v-model="form.parentNumber" placeholder="请输入上级编号" />
        </el-form-item>
        <el-form-item label="链接" prop="url">
        ...
        <el-form-item label="收缩" prop="state">
          <el-input v-model="form.state" placeholder="请输入收缩" />
        </el-form-item>
        <el-form-item label="排序" prop="sort">
        ...
        <el-form-item label="功能按钮" prop="pushBtn">
          <el-input v-model="form.pushBtn" placeholder="请输入功能按钮" />
        </el-form-item>
        <el-form-item label="图标" prop="icon">
...
<script>
import { listFunction, getFunction, delFunction, addFunction, updateFunction } from "@/api/erp/function";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除功能模块编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('xsystem/function/export', {
        ...this.queryParams
