<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="logList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作模块名称" align="center" prop="operation" />
      <el-table-column label="客户端IP" align="center" prop="clientIp" />
      <el-table-column label="操作状态 0==成功，1==失败" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="操作模块名称" prop="operation">
          <el-input v-model="form.operation" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="客户端IP" prop="clientIp">
...
<script>
import { listLog, getLog, delLog, addLog, updateLog } from "@/api/erp/log";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('xsystem/log/export', {
        ...this.queryParams
